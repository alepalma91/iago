...
describe("sandbox path builders", () => {
  ...
  it("should handle large PR numbers", () => {
    expect(getWorktreePath("org/repo", 99999, baseDir)).toBe(
      "/home/user/.local/share/the-reviewer/worktrees/github.com/org/repo/pr-99999"
    );
  });
});
